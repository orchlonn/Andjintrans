...
const OurSkills = () => {
  const data = [
    ...
    { title: "Далайн тээвэр", percent: "[60%]", prw: "w-2/5", width: "w-3/5" },
    {
    ...
    {
      title: "Авто тээвэрлэлтийн үйлчилгээ",
      percent: "[100%]",
      prw: "w-1/3",
      width: "w-3/4",
    },
      ...
      <div className="px-10 md:px-20 container mx-auto py-10 md:py-40 md:flex md:space-x-10">
        <div className="lg:flex w-full h-full   space-y-10 lg:space-y-0">
          <div
            ...
            className="lg:w-1/2 hidden lg:block w-full lg:h-full lg:absolute left-0 top-0 "
          >
          ...
          <div className=" space-y-5  lg:w-1/2 ">
            ...
            >
              You ca achive and Progress information{" "}
              <a className="text-[#277ecd]">Skill</a> Development.
            </div>
            <div className="space-y-5 w-full">
              {data.map((item) => (
                <div
                  ...
                  data-sal-duration={1000}
                >
                  <div className="font-bold text-base md:text-md lg:text-lg">
                    {item.title}
                  </div>
                  <div className="flex">
                    ...
                    <div className={`relative border-2 ${item.prw}`}>
                      ...
                      <div className="absolute right-0 bottom-2 text-[#277ecd]">
                        {item.percent}
                      </div>
                    </div>
                  </div>
