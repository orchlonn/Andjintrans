...
const ClientReview = () =>{
    ...
    <div className=" py-10 md:py-20 space-y-10">
        <div data-sal="slide-down"
                 data-delay="1000"
                 data-sal-duration={1000}   className="space-y-2.5 text-center ">
            ...
            <div className="font-semibold text-xl md:text-2xl lg:text-3xl">We are Interested for Your <a className="text-[#277ecd]">Service</a> of Ocean Freight</div>                
